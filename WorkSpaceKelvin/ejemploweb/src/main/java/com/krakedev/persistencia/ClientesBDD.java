...
public class ClientesBDD {
	...
	public void actualizar(Cliente cliente) throws KrakeDevException {
		...
		try {
			...
			PreparedStatement ps = con.prepareStatement(
					"update clientes set nombre =?, numeroHijos=? where cedula = '" + cliente.getCedula() + "'");
	...
	public ArrayList<Cliente> retornarPorHijos(int cantidadHijos) throws KrakeDevException {
		ArrayList<Cliente> clientes = new ArrayList<Cliente>();
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
